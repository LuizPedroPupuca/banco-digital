...
public class CompraDebitoRequest implements CompraRequest {
    ...
    public CompraDebitoRequest(String numeroCartao, String cv, LocalDate validade, Long idProduto, int qtde) {
